...
// IRequestCache is an interface for caching data within a single request.
// For convenience of testing and replacing the implementation.
type IRequestCache[K comparable, T any] interface {
	...
	GetOrFetch(ctx context.Context, dataKey K,
